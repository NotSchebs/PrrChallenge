...
-   **Daten laden**: Die CSV-Datei wird mit read.csv eingelesen und in das Objekt data gespeichert. Dieses wird anschließend in DF kopiert.
...
es, dass die Teams außerhalb der Top `a` einen unterdurchschnittlichen
...
bedeutet es, dass es keine großen Unterschiede zwischen den Teams
gibt.</p>
...
-   https://studyflix.de
-   https://spaces.technik.fhnw.ch/storage/uploads/mml/2019/09/marcelsteinerskriptwahrscheinlichkeitstheorieundstatistik.pdf
-   https://rstudio.github.io/renv/articles/renv.html
-   https://rcourses.pages.fhnw.ch/programmieren-in-r/
